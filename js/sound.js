...
var Sound = (function () {
  ...
  return {
    ...
    /* 全セット終了。ここだけは短い音楽にする。
       駆け上がってから和音で伸ばす。和音が伸びているあいだに
       「おつかれさまでした」の声が重なるので、ぶつからない。
       それでもゴングにはしない。音量は合図音と同じ範囲に収める。 */
    finish: function () {
      if (!enabled) return;
      bell(783.99, 0.00, 0.40, 0.20);   /* G5 */
      bell(1046.50, 0.13, 0.40, 0.20);  /* C6 */
      bell(1318.51, 0.26, 0.40, 0.20);  /* E6 */
      bell(1567.98, 0.39, 0.55, 0.20);  /* G6 */
      /* 和音。1音ずつは弱くして、重なっても大きくなりすぎないようにする */
      bell(1046.50, 0.62, 1.80, 0.13);  /* C6 */
      bell(1318.51, 0.64, 1.80, 0.11);  /* E6 */
      bell(1567.98, 0.66, 1.80, 0.09);  /* G6 */
    },
